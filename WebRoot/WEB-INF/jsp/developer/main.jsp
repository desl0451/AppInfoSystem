...
<html lang="en">
  ...
  <body class="nav-md">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="${pageContext.request.contextPath }/dev/logout.html"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
    ...
    <!-- Flot -->
    <script src="${pageContext.request.contextPath }/statics/js/jquery.flot.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/jquery.flot.pie.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/jquery.flot.time.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/jquery.flot.stack.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="${pageContext.request.contextPath }/statics/js/jquery.flot.orderBars.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/jquery.flot.spline.min.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="${pageContext.request.contextPath }/statics/js/date.js"></script>
    <!-- JQVMap -->
    <script src="${pageContext.request.contextPath }/statics/js/jquery.vmap.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/jquery.vmap.world.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/jquery.vmap.sampledata.js"></script>
