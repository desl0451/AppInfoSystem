        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>学员信息</span></a>
            </div>
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    <ul class="quick-list">
                      ...
                      <li><i class="fa fa-area-chart"></i><a href="${pageContext.request.contextPath }/manager/logout">Logout</a>
                      </li>
                    </ul>
